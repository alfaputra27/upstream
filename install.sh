...
# Fungsi untuk menampilkan Docker yang berjalan
function show_docker() {
    print_step "Daftar container Docker yang berjalan" "cyan"
    docker ps
}
...
while true; do
    ...
    case $CHOICE in
        ...
        3) show_docker ;;
        4) run_rclone ;;
        5) print_color "green" "Keluar dari script. Terima kasih!" ; exit ;;
